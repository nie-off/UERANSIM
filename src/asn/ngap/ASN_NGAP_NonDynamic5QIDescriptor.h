...
#ifndef	_ASN_NGAP_NonDynamic5QIDescriptor_H_
#define	_ASN_NGAP_NonDynamic5QIDescriptor_H_
...
/* ASN_NGAP_NonDynamic5QIDescriptor */
typedef struct ASN_NGAP_NonDynamic5QIDescriptor {
	ASN_NGAP_FiveQI_t	 fiveQI;
	ASN_NGAP_PriorityLevelQos_t	*priorityLevelQos;	/* OPTIONAL */
...
} ASN_NGAP_NonDynamic5QIDescriptor_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ASN_NGAP_NonDynamic5QIDescriptor;
extern asn_SEQUENCE_specifics_t asn_SPC_ASN_NGAP_NonDynamic5QIDescriptor_specs_1;
extern asn_TYPE_member_t asn_MBR_ASN_NGAP_NonDynamic5QIDescriptor_1[5];

#ifdef __cplusplus
}
#endif

#endif	/* _ASN_NGAP_NonDynamic5QIDescriptor_H_ */
