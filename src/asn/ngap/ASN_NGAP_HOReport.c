...
static asn_oer_constraints_t asn_OER_type_ASN_NGAP_handoverReportType_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_ASN_NGAP_sourcecellC_RNTI_constr_11 CC_NOTUSED = {
	{ 0, 0 },
	16	/* (SIZE(16..16)) */};
...
asn_TYPE_descriptor_t asn_DEF_ASN_NGAP_handoverReportType_2 = {
	...
	{ &asn_OER_type_ASN_NGAP_handoverReportType_constr_2, &asn_PER_type_ASN_NGAP_handoverReportType_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_ASN_NGAP_HOReport_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct ASN_NGAP_HOReport, sourcecellC_RNTI),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ASN_NGAP_sourcecellC_RNTI_constr_11, &asn_PER_memb_ASN_NGAP_sourcecellC_RNTI_constr_11,  memb_ASN_NGAP_sourcecellC_RNTI_constraint_1 },
		0, 0, /* No default value */
		"sourcecellC-RNTI"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_NGAP_HOReport, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_NGAP_ProtocolExtensionContainer_9673P100,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
