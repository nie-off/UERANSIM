...
#ifndef	_ASN_NGAP_PDUSessionResourceModifyIndicationTransfer_H_
#define	_ASN_NGAP_PDUSessionResourceModifyIndicationTransfer_H_
...
/* ASN_NGAP_PDUSessionResourceModifyIndicationTransfer */
typedef struct ASN_NGAP_PDUSessionResourceModifyIndicationTransfer {
...
} ASN_NGAP_PDUSessionResourceModifyIndicationTransfer_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ASN_NGAP_PDUSessionResourceModifyIndicationTransfer;

#ifdef __cplusplus
}
#endif

#endif	/* _ASN_NGAP_PDUSessionResourceModifyIndicationTransfer_H_ */
