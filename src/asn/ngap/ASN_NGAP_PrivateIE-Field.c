...
static asn_oer_constraints_t asn_OER_memb_ASN_NGAP_id_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_ASN_NGAP_PrivateMessageIEs_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_NGAP_PrivateMessageIEs, id),
		...
		0,
		{ &asn_OER_memb_ASN_NGAP_id_constr_2, &asn_PER_memb_ASN_NGAP_id_constr_2,  memb_ASN_NGAP_id_constraint_1 },
