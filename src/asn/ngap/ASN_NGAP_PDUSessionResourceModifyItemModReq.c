...
static asn_oer_constraints_t asn_OER_memb_ASN_NGAP_pDUSessionResourceModifyRequestTransfer_constr_4 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
asn_TYPE_member_t asn_MBR_ASN_NGAP_PDUSessionResourceModifyItemModReq_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_NGAP_PDUSessionResourceModifyItemModReq, pDUSessionResourceModifyRequestTransfer),
		...
		0,
		{ &asn_OER_memb_ASN_NGAP_pDUSessionResourceModifyRequestTransfer_constr_4, &asn_PER_memb_ASN_NGAP_pDUSessionResourceModifyRequestTransfer_constr_4,  memb_ASN_NGAP_pDUSessionResourceModifyRequestTransfer_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_NGAP_PDUSessionResourceModifyItemModReq, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_NGAP_ProtocolExtensionContainer_9673P170,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
