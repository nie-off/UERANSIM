...
typedef enum ASN_NGAP_CauseRadioNetwork {
	...
	ASN_NGAP_CauseRadioNetwork_rsn_not_available_for_the_up	= 48,
	ASN_NGAP_CauseRadioNetwork_npn_access_denied	= 49,
	ASN_NGAP_CauseRadioNetwork_cag_only_access_denied	= 50,
	ASN_NGAP_CauseRadioNetwork_insufficient_ue_capabilities	= 51
...
oer_type_decoder_f ASN_NGAP_CauseRadioNetwork_decode_oer;
oer_type_encoder_f ASN_NGAP_CauseRadioNetwork_encode_oer;
