 ...
 */
static asn_oer_constraints_t asn_OER_type_ASN_NGAP_cn_Type_constr_3 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_ASN_NGAP_cn_Type_3 = {
	...
	{ &asn_OER_type_ASN_NGAP_cn_Type_constr_3, &asn_PER_type_ASN_NGAP_cn_Type_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_ASN_NGAP_CNTypeRestrictionsForEquivalentItem_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ASN_NGAP_CNTypeRestrictionsForEquivalentItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_NGAP_ProtocolExtensionContainer_9673P35,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
