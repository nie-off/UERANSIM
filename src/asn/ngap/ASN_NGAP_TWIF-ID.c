...
static asn_oer_constraints_t asn_OER_memb_ASN_NGAP_tWIF_ID_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..MAX)) */};
...
static asn_oer_constraints_t asn_OER_type_ASN_NGAP_TWIF_ID_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_member_t asn_MBR_ASN_NGAP_TWIF_ID_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct ASN_NGAP_TWIF_ID, choice.tWIF_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ &asn_OER_memb_ASN_NGAP_tWIF_ID_constr_2, &asn_PER_memb_ASN_NGAP_tWIF_ID_constr_2,  memb_ASN_NGAP_tWIF_ID_constraint_1 },
	...
	{ ATF_POINTER, 0, offsetof(struct ASN_NGAP_TWIF_ID, choice.choice_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ASN_NGAP_ProtocolIE_SingleContainer_9625P42,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-Extensions"
...
asn_TYPE_descriptor_t asn_DEF_ASN_NGAP_TWIF_ID = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ &asn_OER_type_ASN_NGAP_TWIF_ID_constr_1, &asn_PER_type_ASN_NGAP_TWIF_ID_constr_1, CHOICE_constraint },
